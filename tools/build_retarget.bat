...
cl /nologo /EHsc /O2 /MD /std:c++17 /DFBXSDK_SHARED /I"%FBX_ROOT%\include" native\fbx_retarget.cpp /Fo:work\fbx_retarget.obj /Fe:bin\fbx_retarget.exe /link "%FBX_ROOT%\lib\vs2017\x64\release\libfbxsdk.lib"
if errorlevel 1 exit /b 1
