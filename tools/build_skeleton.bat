...
cl /nologo /EHsc /O2 /MD /std:c++17 /DFBXSDK_SHARED /I"%FBX_ROOT%\include" native\fbx_skeleton.cpp /Fo:work\fbx_skeleton.obj /Fe:bin\fbx_skeleton.exe /link "%FBX_ROOT%\lib\vs2017\x64\release\libfbxsdk.lib"
if errorlevel 1 exit /b 1
